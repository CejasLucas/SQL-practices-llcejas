...
Para consultar la secuencia lógica, la jerarquía y la estructura formal de una sentencia SQL completa, puede accederse al siguiente recurso: [👉 Estructura de una Query SQL](00_basic_theory_about_SQL.md)
